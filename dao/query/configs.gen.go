...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.CreatedAt = field.NewInt64(tableName, "created_at")
	_config.UpdatedAt = field.NewInt64(tableName, "updated_at")
	_config.DeletedAt = field.NewInt64(tableName, "deleted_at")
	_config.K = field.NewString(tableName, "k")
	_config.V = field.NewString(tableName, "v")
	_config.Describe = field.NewString(tableName, "describe")
...
func (c *config) updateTableName(table string) *config {
	...
	c.K = field.NewString(table, "k")
	c.V = field.NewString(table, "v")
